...
<section class="section">
    <div class="d-flex justify-content-between mb-3">
        <form action="/guardian/competences" method="get" class="d-flex" id="search-competences">
                                        ...
                                        <div class="modal-body">
                                            <div class="row g-2">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="kkm">KKM</label>
                                                        <input type="number" name="kkm" class="form-control form-control-sm" step="0.1" value="{{ $competence->kkm }}">
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
