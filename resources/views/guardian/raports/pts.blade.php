...
<div class="page-title">
    <h3>PTS</h3>
    <p class="text-subtitle text-muted">Raport PTS kelas <strong>{{ $subGrade->sub_grade }}</strong></p>
</div>
<hr>
<section class="section">
    <div class="row g-1 mb-2">
        <div class="col-12 col-md-6 order-2 order-md-0">
            <form action="/guardian/raports/pts" class="row g-1">
        ...
        <div class="col-12 col-md-6 order-1 orser-md-0 text-md-end">
            ...
            <form action="{{ route('raport_pts_pdf') }}" method="post" class="d-inline-flex">
                ...
                <input type="hidden" name="subGrade" value="{{ $subGrade->id }}">
