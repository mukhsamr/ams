                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <select name="sub_grade_id" class="form-select form-select-sm" required>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <select name="competence_id" id="competence" class="form-select form-select-sm" required>
                                    ...
                                    <option {{ hidden(!($competence->subject_id == $journal->subject_id)) }} value="{{ $competence->id }}" subject="{{ $competence->subject_id }}" data-summary="{{ $competence->summary }}" {{ selected($journal->competence_id == $competence->id) }}>
