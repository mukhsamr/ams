...
<section class="section">
    <div class="row g-1 mb-2">
        <div class="col-12 col-md-6 order-2 order-md-0">
            <form action="/operator/attendance" method="get" class="d-flex">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer d-flex justify-content-between">
                        <form action="/operator/attendance/qrcode" method="post">
                            @csrf @method('put')
                            <button type="submit" class="btn btn-secondary" onclick="return confirm('Perbaharui QRCode')">Perbaharui</button>
                        </form>
                        <a href="/operator/attendance/qrcode" class="btn btn-primary" onclick="return confirm('Download QRCode?')">Download</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="export" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="exportLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="/operator/attendance/export" method="post">
                        @csrf
                        <div class="modal-header">
                                            ...
                                            <div class="row g-2">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    <select name="status" class="form-select form-select-sm">
                                                        ...
                                                        <option value="{{ $value }}" {{ $value == $attendance->status ? 'selected' : '' }}>{{ $value }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-12">
