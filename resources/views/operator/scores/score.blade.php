...
<section class="section">
    <div class="d-flex justify-content-between mb-3">
        <form action="/teacher/scores/search" method="get" class="d-flex" id="search-score">
            <select name="subject" class="form-select form-select-sm form-select form-select-sm-sm w-auto " id="subject" required>
            ...
            <select name="sub_grade" class="form-select form-select-sm form-select form-select-sm-sm w-auto  ms-2" id="sub_grade" required>
            ...
            <select name="competence" class="form-select form-select-sm form-select form-select-sm-sm w-auto  ms-2" id="competence" required>
                <option hidden></option>
