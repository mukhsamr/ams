...
<div class="page-title">
    <h3>Beranda</h3>
    <p class="text-subtitle text-muted">Beranda operator</p>
</div>
<hr>

<section class="section">
    <form action="/operator/home" method="get" class="d-flex mb-3">
        <select name="subGrade" class="form-select form-select-sm w-auto" onchange="this.form.submit()">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="/operator/home/{{ $selected }}/{{ $subject->id }}" class="load-modal" data-target="#info"><i data-feather="info"></i></a></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
...
@push('scripts')
<script src="{{ asset('js/operator/home.js') }}"></script>
@endpush
