...
<section class="section">
    <div class="row g-1 mb-2">
        <div class="col-12 col-md-6 order-2 order-md-0">
            <form action="/teacher/competences" method="get" class="row g-1" id="search-competences">
                <div class="col-9">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="/teacher/competences/edit/{{ $competence->id }}" class="btn btn-sm btn-info load-modal" data-target="#edit"><i data-feather="edit"></i></a>
                        </td>
...
@push('scripts')
<script src="{{ asset('js/teacher/competence.js') }}"></script>
@endpush
